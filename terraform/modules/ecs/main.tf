  ...
  container_definitions = jsonencode([
    {
      ...
      # Uncomment to add secrets from AWS Secrets Manager or SSM Parameter Store
      # secrets = [
      #   {
      #     name      = "SECRET_NAME"
...
resource "aws_ecs_service" "main" {
  ...
  # Service will not be updated if task definition changes outside Terraform
  lifecycle {
...
data "aws_lb" "main" {
  arn = element(split("/", var.target_group_arn), 0)
}
